        ...
        <div className='h-full flex flex-col justify-between'>
          <div className='space-y-5'>
            <div className='flex w-full'>
              <img src="./../src/assets/header/side-bg.png" className='object-fit' alt="" />
            </div>
            ...
            <div>
              ...
              >
                ...
                <h1 className='text-bold my-auto font-bold text-left w-[120px] leading-[15px] text-sm'>SERVICES MANAGEMENT</h1>

                {
                  isCollapse
                    ...
                    <FaAngleDown
                      id="hs-unstyled-collapse"
                      data-hs-collapse="#hs-unstyled-collapse-heading"
                      className='my-auto mr-[10px]' size={"15px"}
                    />
                    :
                    <FaAngleUp
                      id="hs-unstyled-collapse"
              ...
              >                <FaCommentAlt className='my-auto' size={"15px"} />
                <h1 className='text-bold my-auto font-bold text-sm'>INQUIRIES</h1>
              </Link>
            </div>
          </div>
          ...
          <div className='hs-dropdown sm:flex md:hidden w-full bg-gradient-to-r from-[#295141] to-[#408D51] h-[90px]'>
            ...
            <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 w-56 hidden z-[63] mt-2 min-w-[16rem] bg-white shadow-md rounded-lg p-2" aria-labelledby="hs-dropdown-profile">
              <Link
                to="/"
                onClick={() => {
                  window.innerWidth >= 320 && window.innerWidth <= 1023
