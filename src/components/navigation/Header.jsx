      ...
      try {
        ...
        if (response.status === 200) {
          ...
          const filteredNotifications = response.data.filter(
            (item) => item.createdAt > res.data[0].createdAt
          );
          ...
          const emptyRead = sortedNotifications.filter(
      ...
      <nav
        className={`h-[70px] bg-gradient-to-r from-[${
          ...
          info.theme.gradient.end !== ""
            ? info.theme.gradient.end
            : "#408D51"
        }] relative z-[50] flex w-full drop-shadow-[0_35px_35px_rgba(0,0,0,0.10)]`}
      >
        <div className=' flex bg-[url("/header-bg.png")] my-auto justify-between w-full h-full pr-[20px]'>
          ...
          <div className="gap-5 flex">
                ...
                <div
                  className={
                    notification.length !== 0
                      ? "mt-[-50px] bg-white h-[500px] shadow-md rounded-lg p-2 pb-[20px]"
                      : "mt-[-50px] bg-white shadow-md rounded-lg p-2 pb-[20px]"
                  }
                >
            ...
            <div className="hs-dropdown bg-white w-[40px] h-[40px] rounded-[100%] relative my-auto sm:hidden md:flex">
              ...
              >
                <div className="mt-[-35px] font-medium bg-white shadow-md rounded-lg p-2">
                  <Link
