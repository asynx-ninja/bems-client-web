...
const CancelRequestModal = ({ viewRequest }) => {
  ...
  const handleOnCancel = async (e) => {
    ...
    try {
      const response = await axios.patch(
        `${API_LINK}/requests/cancel/?req_id=${viewRequest._id}&status=Cancelled`
      );
      ...
      if (response.status === 200) {
        ...
        const notify = {
          ...
          compose: {
            ...
            message: `A user has cancelled a request ${
