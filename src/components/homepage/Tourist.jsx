  ...
  return (
    ...
    >
      <div
        ...
        data-aos-once="false"
        className=" sm:block md:mt-32 md:mb-32 md:px-14 mt-6 px-4 mb-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full md:w-full mx-auto container justify-center items-center"
      >
