    ...
    <div className="flex flex-col bg-gray-100 h-auto">
      ...
      <div className="p-4 lg:p-10 overflow-hidden">
        <div className="flex flex-col">
          ...
          {/* Table */}
          <div className="overflox-hidden max-h-[380px] lg:max-h-[680px] border border-b-0 mt-5 rounded-t-xl bg-white">
            <table className="overflox-hidden overflow-x-auto overflow-y-auto w-full divide-y divide-gray-200">
