        ...
        <div className="sm:w-full lg:w-[80%] flex flex-col">
          <div className="flex flex-col lg:flex-row w-full ">
            ...
            <div className="flex sm:flex-col md:flex-row w-full h-auto ">
              ...
              <div className="sm:mt-[20px] sm:mx-auto md:mt-0 flex w-full justify-end">
                {/* COMPOSE BUTTON */}
                <button
                  type="button"
                ...
                {/* ARCHIVE BUTTON */}
                <div className="hs-tooltip inline-block mx-[10px] my-auto w-[50px] mr-[3.5rem]">
                  <button
                    type="button"
                    data-hs-overlay="#hs-modal-archiveInquiry"
                    className="hs-tooltip-toggle flex justify-center items-center rounded-lg bg-pink-800 text-white font-medium text-sm text-center w-[100px] h-[50px]"
                  >
