...
import profilePicture from "../assets/sample-image/profile.jpg";
...
const Settings = () => {
    ...
    return (
        <div className="mx-4 my-5 md:mx-5 md:my-6 lg:mt-8 lg:mr-6">
            <div className="flex flex-col w-full">
                <b className="border-solid border-0 border-black border-b-2 pb-2 mb-3 uppercase font-heavy text-lg md:text-xl">
                    Profile Settings
                </b>
                <div className="flex sm:flex-col-reverse lg:flex-row-reverse w-full lg:space-x-4 lg:space-x-reverse">
